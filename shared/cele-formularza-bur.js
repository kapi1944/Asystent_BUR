(function zarejestrujCeleFormularzaBur(globalny) {
  ...
  const cele = {
    ...
    kontaktImieNazwisko: definicjaCelu("kontaktImieNazwisko", { selektory: ["#danekontaktowesekcja-imieinazwisko"], sekcja: "Dane kontaktowe", etykieta: "Imię i nazwisko", typKontrolki: "input" }),
    kontaktEmail: definicjaCelu("kontaktEmail", { selektory: ["#danekontaktowesekcja-email"], selektoryAwaryjne: ["#danekontaktowesekcja-adrese-mail"], sekcja: "Dane kontaktowe", etykieta: "E-mail", typKontrolki: "input" }),
    kontaktTelefon: definicjaCelu("kontaktTelefon", { selektory: ["#danekontaktowesekcja-telefon"], sekcja: "Dane kontaktowe", etykieta: "Telefon", typKontrolki: "input" }),
